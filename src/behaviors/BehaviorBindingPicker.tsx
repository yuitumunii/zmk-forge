...
export const BehaviorBindingPicker = ({
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- onBindingChanged/layers intentionally omitted; run only when binding params change (upstream zmk-studio pattern)
  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex flex-col gap-1">
        <span className="text-2xs font-medium text-muted">動作</span>
        <UiSelect
          value={behaviorId}
          className="w-full"
          onChange={(e) => {
