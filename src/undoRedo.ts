...
// Undo/redo controls (the actions + availability), so UI buried inside modals
// can render its own undo/redo buttons without prop-drilling.
...
export const UndoControlsContext = createContext<UndoControls | null>(null);
