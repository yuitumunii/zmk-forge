...
// eslint-disable-next-line react-refresh/only-export-components -- utility exported alongside component for use in Keyboard.tsx
  ...
  const positionItems = positions.map((p, idx) => (
    <div className="absolute" style={scalePosition(p, oneU)}>
      ...
      >
        <Key
          oneU={oneU}
          selected={idx === selectedPosition || (highlightedPositions?.includes(idx) ?? false)}
          {...p}
        />
      </div>
    </div>
